...
import { FUEquipmentSheet } from "./sheets/items/item-equipment-sheet.mjs";
...
Hooks.once("init", async function () {
  ...
  Items.registerSheet("fabulaUltima", FUEquipmentSheet, {
    makeDefault: true,
    types: ["accessory", "armor", "shield", "weapon"],
  });
